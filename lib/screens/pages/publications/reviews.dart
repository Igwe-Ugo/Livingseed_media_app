...
class _ReviewsState extends State<Reviews> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () => GoRouter.of(context).go('${LivingSeedAppRouter.publicationsPath}/${LivingSeedAppRouter.aboutBookPath}/${LivingSeedAppRouter.reviewsPath}/${LivingSeedAppRouter.writeReviewPath}'),
            icon: const Icon(
              Icons.edit_outlined
            ),
          ),
  ...
  List<Widget> buildBooks(BuildContext context, List<Map<String, String>> reviews) {
    return reviews.map((reviewed) => review(
      context,
