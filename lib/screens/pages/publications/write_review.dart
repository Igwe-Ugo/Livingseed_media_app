            ...
            children: [
              ...
              InlineChoice<String>.single(
                ...
                itemBuilder: (state, i) {
                  return ChoiceChip(
                    ...
                    side: BorderSide(color: Theme.of(context).brightness == Brightness.dark ? Colors.white : Theme.of(context).disabledColor.withOpacity(0.7)),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(
                    color: Theme.of(context).brightness == Brightness.dark ? Colors.white : Theme.of(context).disabledColor.withOpacity(0.5),
                  ),
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Tell others what you like (or don\'t like) about this book',
